# Generated by Django 3.0.7 on 2020-08-17 06:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listings', models.ManyToManyField(blank=True, related_name='watch_listing', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_from', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commenter', to=settings.AUTH_USER_MODEL)),
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listing_name', to='auctions.Listing')),
            ],
        ),
        migrations.CreateModel(
            name='Bid',
